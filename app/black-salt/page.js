...
const saltTypes = [
  {
    ...
    images: [
      { src: Black1, label: "Black Salt 1-2mm", description: "Perfect granule size for seasoning" },
      { src: Black2, label: "Black Salt 2-5mm", description: "Ideal for cooking applications" },
      { src: Black3, label: "Black Salt Fine 0.2-0.8mm", description: "Fine texture for delicate dishes" },
      { src: Black4, label: "Black Salt Powder", description: "Ultra-fine powder for even distribution" },
    ],
    description:
    ...
    benefits: [
      ...
      "Low sodium alternative to regular salt",
      "Contains sulfur compounds for unique flavor"
    ]
  },
];
...
const BlackSalt = () => {
  ...
  useEffect(() => {
    ...
    const currentElement = componentRef.current; // copy once
    ...
    return () => {
      if (currentElement) {
        observer.unobserve(currentElement); // use stable reference
      }
    };
  }, []);
  ...
  return (
    <div className="md:pl-[190px] lg:mt-[30px] relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-20 right-10 w-32 h-32 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full opacity-20 animate-pulse"></div>
      <div className="absolute bottom-40 left-20 w-20 h-20 bg-gradient-to-r from-teal-100 to-blue-100 rounded-full opacity-30 animate-bounce delay-300"></div>
        ...
        >
          ...
          <div className=" mb-8 md:mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent sm:text-4xl">
                {salt.name}
              </h2>
              <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full animate-pulse delay-300"></div>
            </div>
          ...
          <div className={`max-w-6xl mx-auto mt-12 px-3 md:px-8 transition-all duration-1000 delay-500 transform ${
            ...
            {/* Main Description */}
            <div className="bg-gradient-to-br lg:ml-[20px] from-white to-blue-50 rounded-2xl p-8 shadow-lg border border-blue-100">
              <div className="flex items-start gap-4 mb-6">
                <div>
                <div className="w-12 h-12 justify-self-center mb-[20px] bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="grid gap-3">
                    {salt.images.map((image, idx) => (
                      <div 
                        key={idx}
                        className={`p-3 rounded-lg border-2 transition-all duration-300 cursor-pointer transform hover:scale-105 ${
