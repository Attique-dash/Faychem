...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.silverlinetradingcompany.com/white-salt",
    },
  ],
};

export default function WhiteSalt() {
  return (
    <div>
      <script
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 mx-auto pt-10 pb-8">
          ...
          <div className="text-center mb-16 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto">
              Pure, crystalline white salt sourced from the deepest layers of the Khewra mine — ideal for food processing, seasoning, and industrial use.
            </p>
          </div>
